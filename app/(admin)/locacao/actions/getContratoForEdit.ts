...
export async function getContratoForEdit(
  ...
  return {
    ...
    transacoes: allTransactions.map(transaction => ({
      ...
      dataVencimento: transaction.dataVencimento.toISOString(),
      dataPagamento: transaction.dataPagamento?.toISOString() ?? null,
      createdAt: transaction.createdAt.toISOString(),
      metadata: transaction.metadata,
      interStatus: transaction.interStatus,
      interNossoNumero: transaction.interNossoNumero,
      interCodigoSolicitacao: transaction.interCodigoSolicitacao,
      interOrigemRecebimento: transaction.interOrigemRecebimento,
    })),
